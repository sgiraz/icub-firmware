...
void MController_config_joint(int j, eOmc_joint_config_t* config, eOmotioncontroller_mode_t mcmode) //
{
    ...
    Motor_config_friction(o->motor+j, config->motor_params.ktau_value, config->motor_params.friction);
...
{
    Motor_config_friction(smc->motor+m, params->ktau_value, params->friction);
}
